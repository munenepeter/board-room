...
<div class="antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <main class="p-4 md:ml-32 h-auto pt-20 flex justify-between">
        ...
        <div class="max-w-md dark:bg-gray-700 bg-gray-50 rounded-b">
            <div class="px-4">
                <div class="border-b pb-4 border-gray-400 border-dashed">
                    ...
                    <p class="text-sm pt-2 leading-4 leading-none text-gray-600 dark:text-gray-300">Discussion on UX
                        ...
                        <p class="text-sm pt-2 leading-4 leading-none text-gray-600 dark:text-gray-300">Booked by Mwaruguru on 27th June 2023</p>
                </div>
