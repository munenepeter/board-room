    ...
    <div class="w-full p-4">
        <div class="w-full flex items-center py-2">
            ...
            <div class="ml-auto flex items-center">
                ...
                <form action="/system/logs/delete" method="post">
                        ...
                        <tr @click="selected !== <?= $count; ?> ? selected = <?= $count; ?> : selected = null"
                            ...
                            <th scope="row" class="py-3 px-2 md:px-6 flex items-center">
                                ...
                                <?php elseif ($log->level === "Debug"): ?>
                                    ...
                                    <span
                                        class="pl-2 font-medium text-blue-600 whitespace-nowrap dark:text-white"><?= $log->level; ?></span>
                                <?php elseif ($log->level === "Warning"): ?>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                        ...
                                        class="pl-2 font-medium text-yellow-600 whitespace-nowrap dark:text-white"><?= $log->level; ?></span>
                                <?php else: ?>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    ...
                                    <span
                                        class="md:pl-2 font-medium text-green-600 whitespace-nowrap dark:text-white"><?= $log->level; ?></span>
                                <?php endif; ?>
                            </th>
