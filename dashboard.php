        ...
        <div class="lg:w-1/3">
            <div class="bg-white rounded-lg shadow-md p-4">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="meetings.php" class="text-sm text-maroon-600 hover:text-maroon-800">View All</a>
                </div>
                    ...
                    ?>
                            <div class="border border-gray-200 rounded-lg p-4 hover:border-maroon-300 transition-colors">
                                ...
                                <div class="mt-3 flex justify-end">
                                    <a href="booking_success.php?id=<?= $booking['booking_id'] ?>" class="text-sm text-maroon-600 hover:text-maroon-800 font-medium">
                                        View Details
                                    </a>
                                </div>
                            </div>
